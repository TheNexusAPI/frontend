...
const Button = ({ text, theme = "dark" }) => {
  return (
    <>
      {theme == "dark" ? (
        <button className="bg-purple-500 px-8 py-3 text-xl font-medium rounded-full btn relative inline-flex items-center justify-start overflow-hidden transition-all   group">
        ...
        <button className="bg-white text-black font-medium px-8 py-3 text-xl  rounded-full btn relative inline-flex items-center justify-start overflow-hidden transition-all  group">
        ...
        <button className="bg-white text-black px-8 py-3 text-xl rounded-full ">
          {text}
        </button>
      )}
    </>
